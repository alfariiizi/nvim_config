-- Thanks to: https://github.com/nvim-telescope/telescope.nvim/issues/2014
-- Specific code link:
-- - https://github.com/nvim-telescope/telescope.nvim/issues/2014#issuecomment-1690573382
-- - https://github.com/nvim-telescope/telescope.nvim/issues/2014#issuecomment-1750693907
...
function telescopePickers.prettyFilesPicker(pickerAndOptions)
  ...
  elseif pickerAndOptions.picker == 'find_files_recent' then
    require('telescope').extensions['recent-files'].recent_files(options)
